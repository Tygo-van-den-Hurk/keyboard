...
# My First Keyboard
So this the process of me documenting the journey of me making my own first glorious custom keyboard. Or as I will call it, the MF keyboard. Shout out to [@RajuBuddharaju](https://github.com/RajuBuddharaju/) for helping me realise this keyboard. He has been amazing.
...
So the first step to making a custom keyboard is designing the layout. You could go for any of the [standard layouts](https://en.wikipedia.org/wiki/Keyboard_layout) like 100%, 80%, or even 60% keyboards. But those are first of all, no fun. Two, basic, and three, very silly. You're hands aren't made for keyboards like that. Your hands don't go sightly to the side when they go up or down. So why on the planet should your keyboard? 
...
<center>
  <figure>
    ...
    <figcaption>
      <b>Figure 1</b>: This is the final result of what the keyboard should look like. The file used to make this is also in this repository! It's [this file](./ergogen.layout.yaml).
    </figcaption>
  </figure> 
</center>
